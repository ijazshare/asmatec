...
import { networkFeatures, networkSolutions } from "@/constants/network";
  ...
  return (
    <div className="pt-14">
      ...
      <PageHero
        ...
        description="Build a fast, secure, and reliable network foundation that supports your business today and scales for tomorrow."
      />
